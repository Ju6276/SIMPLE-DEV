...
SIMPLE_OPENFAUCET__30 checkpoint on this machine.
...
```bash
test -f /home/d013/桌面/CKPT/JEPA2/SIMPLE_OPENFAUCET__30/steps_40000_pytorch_model.pt
test -d /home/d013/桌面/VLA-JEPA/Qwen3-VL-2B-Instruct
test -d /home/d013/桌面/VLA-JEPA/vjepa2-vitl-fpc64-256
```

The checkpoint directory should also contain:

```text
/home/d013/桌面/CKPT/JEPA2/SIMPLE_OPENFAUCET__30/config.yaml
/home/d013/桌面/CKPT/JEPA2/SIMPLE_OPENFAUCET__30/dataset_statistics.json
```
